...
public class SaveSlot : MonoBehaviour {
    ...
    public void SetSlot(int fileIndex, int displayFormat) {
        ...
        if (saveTemp != null && saveTemp.dataExist != 0) {
            ...
            headerText.colorGradientPreset = (saveTemp.playerIndex == GameManager.playerIndex_HyperServal || saveTemp.playerIndex == GameManager.playerIndex_AnotherServal_Escape || saveTemp.isPlayerHyper != 0 ? rainbowGradient : whiteGradient);
            ...
            bool playerIsDefault = (saveTemp.playerType != GameManager.playerType_Another);
            if (playerIsDefault) {
            ...
            if (GameManager.Instance.IsStandardPlayer(saveTemp))
            {
            ...
            else
            {
                ...
                playerFaceImage.sprite = ItemDatabase.Instance.GetItemImage(CharacterDatabase.Instance.GetPlayerFaceId(saveTemp.playerIndex));
