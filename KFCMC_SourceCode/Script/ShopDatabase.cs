...
public class ShopDatabase : SingletonMonoBehaviour<ShopDatabase> {
    ...
    protected override void Awake() {
        if (CheckInstance()) {
            ...
            shopList.Add(new ShopData((int)ItemID.Japariman, -1, 1));
            shopList.Add(new ShopData((int)ItemID.Japariman_3, -1, 1));
            shopList.Add(new ShopData((int)ItemID.Japariman_5, -1, 1));
