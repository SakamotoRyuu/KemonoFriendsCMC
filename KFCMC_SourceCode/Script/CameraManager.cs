...
public class CameraManager : SingletonMonoBehaviour<CameraManager> {
    ...
    public void ResetCameraFixPos() {
        ...
        if (CharacterManager.Instance.playerTrans && CharacterManager.Instance.playerLookAt) {
            ...
            Quaternion playerRot = CharacterManager.Instance.playerTrans.rotation;
            followPlayerForFL.rotation = playerRot;
            followPlayerForTG.rotation = playerRot;
            targetGroup.transform.rotation = playerRot;
        }
