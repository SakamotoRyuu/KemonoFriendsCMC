...
public class CharacterDatabase : SingletonMonoBehaviour<CharacterDatabase> {
    ...
    public class Enemy {
        ...
        public int maxLevel;
        public bool[] statusExist = new bool[GameManager.enemyLevelMax];
        public bool[] appearInBook = new bool[GameManager.enemyLevelMax];
        public EnemyStatus[] status = new EnemyStatus[GameManager.enemyLevelMax];
        public GameObject cache;
    ...
    */
    ...
    void SetCharacterData() {
        ...
        SetFriends(32, "Prefab/Friends/032_Serval", 6);
        SetFriends(33, "Prefab/Friends/033_HyperServal", 12);
        ...
        enemy[67].path = "Prefab/Enemy/067_GlaucusSeiryu";
        enemy[68].path = "Prefab/Enemy/068_BirdlienSuzaku";
        enemy[69].path = "Prefab/Enemy/069_AkulaByakko";
        enemy[70].path = "Prefab/Enemy/070_CeckyBeastGenbu";
        enemy[71].path = "Prefab/Enemy/071_KitsunezakiIneko";
        enemy[72].path = "Prefab/Enemy/072_QuestionServal";
        ...
        enemy[67].spritePath = "Enemy/face_067_GlaucusSeiryu";
        enemy[68].spritePath = "Enemy/face_068_BirdlienSuzaku";
        enemy[69].spritePath = "Enemy/face_069_AkulaByakko";
        enemy[70].spritePath = "Enemy/face_070_CeckyBeastGenbu";
        enemy[71].spritePath = "Enemy/face_071_KitsunezakiIneko";
        enemy[72].spritePath = "Enemy/face_072_QuestionServal";
        ...
        animCon[33].path = "AnimCon/IFR_Kaban";
        animCon[34].path = "AnimCon/IFR_Hippo";
        animCon[35].path = "AnimCon/IFR_Otter";
        animCon[36].path = "AnimCon/IFR_Jaguar";
        animCon[37].path = "AnimCon/IFR_Ibis";
        animCon[38].path = "AnimCon/IFR_Alpaca";
        animCon[39].path = "AnimCon/IFR_SandCat";
        animCon[40].path = "AnimCon/IFR_Tsuchinoko";
        animCon[41].path = "AnimCon/IFR_Beaver";
        animCon[42].path = "AnimCon/IFR_PrairieDog";
        animCon[43].path = "AnimCon/IFR_Moose";
        animCon[44].path = "AnimCon/IFR_Lion";
        animCon[45].path = "AnimCon/IFR_WhiteOwl";
        animCon[46].path = "AnimCon/IFR_EagleOwl";
        animCon[47].path = "AnimCon/IFR_Margay";
        animCon[48].path = "AnimCon/IFR_PPP_Female";
        animCon[49].path = "AnimCon/IFR_PPP_Male";
        animCon[53].path = "AnimCon/IFR_RedFox";
        animCon[54].path = "AnimCon/IFR_SilverFox";
        animCon[55].path = "AnimCon/IFR_CampoFlicker";
        animCon[56].path = "AnimCon/IFR_GrayWolf";
        animCon[57].path = "AnimCon/IFR_Giraffe";
        animCon[58].path = "AnimCon/IFR_GoldenMonkey";
        animCon[59].path = "AnimCon/IFR_BrownBear";
        animCon[60].path = "AnimCon/IFR_PaintedWolf";
        animCon[61].path = "AnimCon/IFR_Raccoon";
        animCon[62].path = "AnimCon/IFR_Fennec";
        animCon[63].path = "AnimCon/IFR_AnotherServal";

        animCon[64].path = "AnimCon/IFR_LuckyBeast";
        animCon[65].path = "AnimCon/IFR_Fossa";
        animCon[66].path = "AnimCon/IFR_Tamandua";
        animCon[67].path = "AnimCon/IFR_ScarletIbis";
        animCon[68].path = "AnimCon/IFR_Oryx";
        animCon[69].path = "AnimCon/IFR_Elephant";
        animCon[70].path = "AnimCon/IFR_AxisDeer";
        animCon[71].path = "AnimCon/IFR_Porcupine";
        animCon[72].path = "AnimCon/IFR_Aurochs";
        animCon[73].path = "AnimCon/IFR_Armadillo";
        animCon[74].path = "AnimCon/IFR_Chameleon";
        animCon[75].path = "AnimCon/IFR_Shoebill";
        animCon[76].path = "AnimCon/IFR_GiantPenguin";
        animCon[77].path = "AnimCon/IFR_Capybara";
        animCon[78].path = "AnimCon/IFR_Tapir";
        animCon[79].path = "AnimCon/IFR_Aardwolf";
        animCon[80].path = "AnimCon/IFR_Dolphin";
        animCon[81].path = "AnimCon/IFR_LuckyBeastGenbu";
        animCon[82].path = "AnimCon/IFR_LuckyBeastType3";
        animCon[83].path = "AnimCon/IFR_Nana";
        animCon[84].path = "AnimCon/IFR_Mirai";
        animCon[85].path = "AnimCon/IFR_Kako";
        animCon[86].path = "AnimCon/IFR_2ndServal";
        animCon[87].path = "AnimCon/IFR_Oinarisama";
        animCon[88].path = "AnimCon/IFR_Kitsunezaki";

        animCon[89].path = "AnimCon/IFR_SitChair";
        animCon[90].path = "AnimCon/IFR_IbisAp";
        animCon[91].path = "AnimCon/IFR_MargayAp";
        ...
        */
        ...
        SetPlayer(GameManager.playerIndex_Serval, "Prefab/Friends/Player_Serval", -1, 132, 0);
        SetPlayer(GameManager.playerIndex_Parkman, "Prefab/Friends/Player_Parkman", -1, 108, -1);
        SetPlayer(GameManager.playerIndex_HyperServal, "Prefab/Friends/Player_HyperServal", -1, 133, -1);
        SetPlayer(GameManager.playerIndex_AnotherServal, "Prefab/Friends/Player_AnotherServal", 31, 131, 31);
        SetPlayer(GameManager.playerIndex_AnotherServal_Escape, "Prefab/Friends/Player_AnotherServal_Escape", -1, 131, -1);
        SetPlayer(4 + 1, "Prefab/Friends/Player_001_Kaban", 1, 101, 1);
        SetPlayer(4 + 2, "Prefab/Friends/Player_002_Hippo", 2, 102, 2);
        SetPlayer(4 + 3, "Prefab/Friends/Player_003_Otter", 3, 103, 3);
        SetPlayer(4 + 4, "Prefab/Friends/Player_004_Jaguar", 4, 104, 4);
        SetPlayer(4 + 5, "Prefab/Friends/Player_005_Ibis", 5, 105, 5);
        SetPlayer(4 + 6, "Prefab/Friends/Player_006_Alpaca", 6, 106, 6);
        SetPlayer(4 + 7, "Prefab/Friends/Player_007_SandCat", 7, 107, 7);
        SetPlayer(4 + 8, "Prefab/Friends/Player_008_Tsuchinoko", 8, 108, 8);
        SetPlayer(4 + 9, "Prefab/Friends/Player_009_Beaver", 9, 109, 9);
        SetPlayer(4 + 10, "Prefab/Friends/Player_010_PrairieDog", 10, 110, 10);
        SetPlayer(4 + 11, "Prefab/Friends/Player_011_Moose", 11, 111, 11);
        SetPlayer(4 + 12, "Prefab/Friends/Player_012_Lion", 12, 112, 12);
        SetPlayer(4 + 13, "Prefab/Friends/Player_013_WhiteOwl", 13, 113, 13);
        SetPlayer(4 + 14, "Prefab/Friends/Player_014_EagleOwl", 14, 114, 14);
        SetPlayer(4 + 15, "Prefab/Friends/Player_015_Margay", 15, 115, 15);
        SetPlayer(4 + 16, "Prefab/Friends/Player_016_Princess", 16, 116, 16);
        SetPlayer(4 + 17, "Prefab/Friends/Player_017_Rocker", 17, 117, 17);
        SetPlayer(4 + 18, "Prefab/Friends/Player_018_Gean", 18, 118, 18);
        SetPlayer(4 + 19, "Prefab/Friends/Player_019_Hululu", 19, 119, 19);
        SetPlayer(4 + 20, "Prefab/Friends/Player_020_Emperor", 20, 120, 20);
        SetPlayer(4 + 21, "Prefab/Friends/Player_021_RedFox", 21, 121, 21);
        SetPlayer(4 + 22, "Prefab/Friends/Player_022_SilverFox", 22, 122, 22);
        SetPlayer(4 + 23, "Prefab/Friends/Player_023_CampoFlicker", 23, 123, 23);
        SetPlayer(4 + 24, "Prefab/Friends/Player_024_GrayWolf", 24, 124, 24);
        SetPlayer(4 + 25, "Prefab/Friends/Player_025_Giraffe", 25, 125, 25);
        SetPlayer(4 + 26, "Prefab/Friends/Player_026_GoldenMonkey", 26, 126, 26);
        SetPlayer(4 + 27, "Prefab/Friends/Player_027_BrownBear", 27, 127, 27);
        SetPlayer(4 + 28, "Prefab/Friends/Player_028_PaintedWolf", 28, 128, 28);
        SetPlayer(4 + 29, "Prefab/Friends/Player_029_Raccoon", 29, 129, 29);
        SetPlayer(4 + 30, "Prefab/Friends/Player_030_Fennec", 30, 130, 30);
    ...
    void LoadEnemyTable() {
        ...
        for (int i = 0; i < GameManager.enemyMax; i++)
        {
            enemy[i].status = new EnemyStatus[enemy[i].maxLevel + 1];
        }
        while (reader.Peek() > -1) {
    ...
    */
    ...
    void SetUICache() {
        ...
        ui.enemyBalloon = Resources.Load("Prefab/UI/EnemyBalloon", typeof(GameObject)) as GameObject;
    ...
    void SetPlayer(int id, string path, int friendsId, int faceId, int choiceId)
    {
        players[id].path = path;
        players[id].friendsId = friendsId;
        players[id].faceId = faceId;
        players[id].choiceId = choiceId;
    }
    ...
    */
    ...
    public GameObject GetPlayer(int id)
    {
        ...
        if (players[id].cache == null)
        {
            players[id].cache = Resources.Load(players[id].path, typeof(GameObject)) as GameObject;
        }
        return players[id].cache;
    }

    public int GetPlayerFaceId(int id)
    {
        if (id < 0 || id >= players.Length)
        {
            id = 0;
        }
        return players[id].faceId;
    }

    public int GetPlayerFaceIdWithChoiceId(int choiceId)
    {
        for (int i = 0; i < players.Length; i++)
        {
            if (players[i].choiceId == choiceId)
            {
                return players[i].faceId;
            }
        }
        return -1;
    }

    public int GetPlayerIdWithChoiceId(int choiceId)
    {
        for (int i = 0; i < players.Length; i++)
        {
            if (players[i].choiceId == choiceId)
