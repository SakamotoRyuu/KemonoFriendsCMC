...
public class GameOver : MonoBehaviour {
        ...
        switch (state) {
            ...
            case 3:
                if (SceneChange.Instance.GetEyeCatch()) {
                    ...
                    StageManager.Instance.MoveStage(0, StageManager.Instance.GetHomeFloorNumber(), -1);
    ...
    protected virtual void SetChoices() {
        PauseController.Instance.SetChoices(3, true, TextManager.Get("WORD_GAMEOVER"), StageManager.Instance.GetReturnToHomeText(GameManager.Instance.IsPlayerAnother), "CHOICE_RESTART", "CHOICE_QUIT_GAME");
    }
