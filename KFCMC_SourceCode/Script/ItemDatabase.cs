...
public class ItemDatabase : SingletonMonoBehaviour<ItemDatabase> {
    ...
    private static readonly ItemID[] notConsumableId = new ItemID[] { ItemID.FDKaban, ItemID.RainbowFeather };
    ...
    protected override void Awake() {
        if (CheckInstance()) {
            ...
            itemList.Add(new ItemData((int)ItemID.Heal0, 8, Resources.Load("Item/heal_00", typeof(Sprite)) as Sprite, "Prefab/Item/000_Heal0"));
            itemList.Add(new ItemData((int)ItemID.Heal1, 20, Resources.Load("Item/heal_01", typeof(Sprite)) as Sprite, "Prefab/Item/001_Heal1"));
            itemList.Add(new ItemData((int)ItemID.Heal2, 50, Resources.Load("Item/heal_02", typeof(Sprite)) as Sprite, "Prefab/Item/002_Heal2"));
            itemList.Add(new ItemData((int)ItemID.Sandstar, 30, Resources.Load("Item/heal_09", typeof(Sprite)) as Sprite, "Prefab/Item/009_Sandstar"));

            itemList.Add(new ItemData((int)ItemID.Antidote, 10, Resources.Load("Item/buff_00", typeof(Sprite)) as Sprite, "Prefab/Item/020_Antidote"));
            itemList.Add(new ItemData((int)ItemID.BuffStamina, 30, Resources.Load("Item/buff_01", typeof(Sprite)) as Sprite, "Prefab/Item/021_BuffStamina"));
            itemList.Add(new ItemData((int)ItemID.BuffSpeed, 30, Resources.Load("Item/buff_02", typeof(Sprite)) as Sprite, "Prefab/Item/022_BuffSpeed"));
            itemList.Add(new ItemData((int)ItemID.BuffAttack, 45, Resources.Load("Item/buff_03", typeof(Sprite)) as Sprite, "Prefab/Item/023_BuffAttack"));
            itemList.Add(new ItemData((int)ItemID.BuffDefense, 45, Resources.Load("Item/buff_04", typeof(Sprite)) as Sprite, "Prefab/Item/024_BuffDefense"));
            itemList.Add(new ItemData((int)ItemID.BuffKnock, 60, Resources.Load("Item/buff_05", typeof(Sprite)) as Sprite, "Prefab/Item/025_BuffKnock"));
            itemList.Add(new ItemData((int)ItemID.BuffAbsorb, 60, Resources.Load("Item/buff_06", typeof(Sprite)) as Sprite, "Prefab/Item/026_BuffAbsorb"));
            itemList.Add(new ItemData((int)ItemID.BuffStealth, 80, Resources.Load("Item/buff_07", typeof(Sprite)) as Sprite, "Prefab/Item/027_BuffStealth"));
            itemList.Add(new ItemData((int)ItemID.BuffLong, 100, Resources.Load("Item/buff_08", typeof(Sprite)) as Sprite, "Prefab/Item/028_BuffLong"));
            itemList.Add(new ItemData((int)ItemID.BuffMulti, 150, Resources.Load("Item/buff_09", typeof(Sprite)) as Sprite, "Prefab/Item/029_BuffMulti"));

            itemList.Add(new ItemData((int)ItemID.GraphWarp, 10, Resources.Load("Item/graph_00", typeof(Sprite)) as Sprite, "Prefab/Item/040_GraphWarp"));
            itemList.Add(new ItemData((int)ItemID.GraphGuide, 30, Resources.Load("Item/graph_01", typeof(Sprite)) as Sprite, "Prefab/Item/041_GraphGuide"));
            itemList.Add(new ItemData((int)ItemID.GraphClearTraps, 30, Resources.Load("Item/graph_02", typeof(Sprite)) as Sprite, "Prefab/Item/042_GraphClearTraps"));
            itemList.Add(new ItemData((int)ItemID.GraphGold, 50, Resources.Load("Item/graph_03", typeof(Sprite)) as Sprite, "Prefab/Item/043_GraphGold"));
            itemList.Add(new ItemData((int)ItemID.GraphBreak, 50, Resources.Load("Item/graph_04", typeof(Sprite)) as Sprite, "Prefab/Item/044_GraphBreak"));
            itemList.Add(new ItemData((int)ItemID.GraphBuild, 60, Resources.Load("Item/graph_05", typeof(Sprite)) as Sprite, "Prefab/Item/045_GraphBuild"));
            itemList.Add(new ItemData((int)ItemID.GraphConnect, 20, Resources.Load("Item/graph_06", typeof(Sprite)) as Sprite, "Prefab/Item/046_GraphConnect"));

            itemList.Add(new ItemData((int)ItemID.CrystalGreen_S, 50, Resources.Load("Item/crystal_00", typeof(Sprite)) as Sprite, "Prefab/Item/050_CrystalGreen_S"));
            itemList.Add(new ItemData((int)ItemID.CrystalGreen_M, 100, Resources.Load("Item/crystal_01", typeof(Sprite)) as Sprite, "Prefab/Item/051_CrystalGreen_M"));
            itemList.Add(new ItemData((int)ItemID.CrystalGreen_L, 200, Resources.Load("Item/crystal_02", typeof(Sprite)) as Sprite, "Prefab/Item/052_CrystalGreen_L"));
            itemList.Add(new ItemData((int)ItemID.CrystalBlack, 40, Resources.Load("Item/crystal_03", typeof(Sprite)) as Sprite, "Prefab/Item/053_CrystalBlack"));
            itemList.Add(new ItemData((int)ItemID.CrystalRed, 40, Resources.Load("Item/crystal_04", typeof(Sprite)) as Sprite, "Prefab/Item/054_CrystalRed"));
            itemList.Add(new ItemData((int)ItemID.CrystalBlue, 80, Resources.Load("Item/crystal_05", typeof(Sprite)) as Sprite, "Prefab/Item/055_CrystalBlue"));
            itemList.Add(new ItemData((int)ItemID.CrystalViolet, 80, Resources.Load("Item/crystal_06", typeof(Sprite)) as Sprite, "Prefab/Item/056_CrystalViolet"));
            itemList.Add(new ItemData((int)ItemID.CrystalYellow, 200, Resources.Load("Item/crystal_07", typeof(Sprite)) as Sprite, "Prefab/Item/057_CrystalYellow"));
            itemList.Add(new ItemData((int)ItemID.CrystalCrimson, 200, Resources.Load("Item/crystal_08", typeof(Sprite)) as Sprite, "Prefab/Item/058_CrystalCrimson"));
            itemList.Add(new ItemData((int)ItemID.CrystalWhite, 400, Resources.Load("Item/crystal_09", typeof(Sprite)) as Sprite, "Prefab/Item/059_CrystalWhite"));

            itemList.Add(new ItemData((int)ItemID.BombNormal, 60, Resources.Load("Item/bomb_00", typeof(Sprite)) as Sprite, "Prefab/Item/060_BombNormal"));
            itemList.Add(new ItemData((int)ItemID.BombPoison, 60, Resources.Load("Item/bomb_01", typeof(Sprite)) as Sprite, "Prefab/Item/061_BombPoison"));
            itemList.Add(new ItemData((int)ItemID.BombAcid, 60, Resources.Load("Item/bomb_02", typeof(Sprite)) as Sprite, "Prefab/Item/062_BombAcid"));
            itemList.Add(new ItemData((int)ItemID.BombNormal_L, 120, Resources.Load("Item/bomb_03", typeof(Sprite)) as Sprite, "Prefab/Item/063_BombNormal_L"));
            itemList.Add(new ItemData((int)ItemID.BombPoison_L, 120, Resources.Load("Item/bomb_04", typeof(Sprite)) as Sprite, "Prefab/Item/064_BombPoison_L"));
            itemList.Add(new ItemData((int)ItemID.BombAcid_L, 120, Resources.Load("Item/bomb_05", typeof(Sprite)) as Sprite, "Prefab/Item/065_BombAcid_L"));

            itemList.Add(new ItemData((int)ItemID.Japariman, 15, Resources.Load("Item/japariman", typeof(Sprite)) as Sprite, "Prefab/Item/070_Japariman"));
            itemList.Add(new ItemData((int)ItemID.Japariman_2, 30, Resources.Load("Item/japariman_2", typeof(Sprite)) as Sprite, "Prefab/Item/071_Japariman_2"));
            itemList.Add(new ItemData((int)ItemID.Japariman_3, 45, Resources.Load("Item/japariman_3", typeof(Sprite)) as Sprite, "Prefab/Item/072_Japariman_3"));
            itemList.Add(new ItemData((int)ItemID.Japariman_4, 60, Resources.Load("Item/japariman_4", typeof(Sprite)) as Sprite, "Prefab/Item/073_Japariman_4"));
            itemList.Add(new ItemData((int)ItemID.Japariman_5, 75, Resources.Load("Item/japariman_5", typeof(Sprite)) as Sprite, "Prefab/Item/074_Japariman_5"));

            itemList.Add(new ItemData((int)ItemID.SandstarRaw, 666, Resources.Load("Item/sandstarRaw", typeof(Sprite)) as Sprite, "Prefab/Item/080_SandstarRaw"));
            itemList.Add(new ItemData((int)ItemID.CelliumCure, 0, Resources.Load("Item/celliumCure", typeof(Sprite)) as Sprite, "Prefab/Item/081_CelliumCure"));
            itemList.Add(new ItemData((int)ItemID.GoldNugget, 0, Resources.Load("Item/goldNugget", typeof(Sprite)) as Sprite, "Prefab/Item/082_GoldNugget"));
            itemList.Add(new ItemData((int)ItemID.FDKaban, 0, Resources.Load("Item/fdKaban", typeof(Sprite)) as Sprite, "Prefab/Item/083_FDKaban"));
            itemList.Add(new ItemData((int)ItemID.RainbowFeather, 0, Resources.Load("Item/rainbowFeather", typeof(Sprite)) as Sprite, "Prefab/Item/084_RainbowFeather"));
            itemList.Add(new ItemData((int)ItemID.MemoryOrb, 0, Resources.Load("Item/memoryOrb", typeof(Sprite)) as Sprite, "Prefab/Item/085_MemoryOrb"));

            itemList.Add(new ItemData((int)ItemID.Coin_S, 400, Resources.Load("Item/coin_00", typeof(Sprite)) as Sprite, "Prefab/Item/086_Coin_S"));
            itemList.Add(new ItemData((int)ItemID.Coin_M, 700, Resources.Load("Item/coin_01", typeof(Sprite)) as Sprite, "Prefab/Item/087_Coin_M"));
            itemList.Add(new ItemData((int)ItemID.Coin_L, 1200, Resources.Load("Item/coin_02", typeof(Sprite)) as Sprite, "Prefab/Item/088_Coin_L"));
            itemList.Add(new ItemData((int)ItemID.Coin_XL, 2000, Resources.Load("Item/coin_03", typeof(Sprite)) as Sprite, "Prefab/Item/089_Coin_XL"));
            itemList.Add(new ItemData((int)ItemID.MegatonCoin, 20000, Resources.Load("Item/coin_04", typeof(Sprite)) as Sprite, "Prefab/Item/090_MegatonCoin"));

            itemList.Add(new ItemData((int)ItemID.CertificateOfEnlightenment, 0, Resources.Load("Item/certificateOfEnlightenment", typeof(Sprite)) as Sprite, "Prefab/Item/091_CertificateOfEnlightenment"));

            itemList.Add(new ItemData((int)ItemID.Statue_Blue, 0, Resources.Load("Item/statue_blue", typeof(Sprite)) as Sprite, "Prefab/Item/094_Statue_Blue"));
            itemList.Add(new ItemData((int)ItemID.Statue_Red, 0, Resources.Load("Item/statue_red", typeof(Sprite)) as Sprite, "Prefab/Item/095_Statue_Red"));
            itemList.Add(new ItemData((int)ItemID.Statue_Violet, 0, Resources.Load("Item/statue_violet", typeof(Sprite)) as Sprite, "Prefab/Item/096_Statue_Violet"));
            itemList.Add(new ItemData((int)ItemID.Statue_Black, 0, Resources.Load("Item/statue_black", typeof(Sprite)) as Sprite, "Prefab/Item/097_Statue_Black"));
            itemList.Add(new ItemData((int)ItemID.Statue_Silver, 0, Resources.Load("Item/statue_silver", typeof(Sprite)) as Sprite, "Prefab/Item/098_Statue_Silver"));
            itemList.Add(new ItemData((int)ItemID.Statue_Golden, 0, Resources.Load("Item/statue_golden", typeof(Sprite)) as Sprite, "Prefab/Item/099_Statue_Golden"));
            ...
            itemList.Add(new ItemData((int)ItemID.HealStar, -1, Resources.Load("Item/healStar", typeof(Sprite)) as Sprite, "Prefab/Others/352_HealStar"));
            itemList.Add(new ItemData((int)ItemID.UnlockConsole, -1, null, "Prefab/Others/353_UnlockConsole"));
            itemList.Add(new ItemData((int)ItemID.SandstarBlock, -1, Resources.Load("Item/sandstarBlock", typeof(Sprite)) as Sprite, "Prefab/Others/354_SandstarBlock"));
            itemList.Add(new ItemData((int)ItemID.MemoryFragment, -1, null, "Prefab/Others/355_MemoryFragment"));
            itemList.Add(new ItemData((int)ItemID.ComboStar, -1, Resources.Load("Item/comboStar", typeof(Sprite)) as Sprite, "Prefab/Others/356_ComboStar"));
            ...
            itemList.Add(new ItemData(539, -1, Resources.Load("Facility/face_Graph_SisinKemono", typeof(Sprite)) as Sprite, "Prefab/Facility/Graph_SisinKemono"));
    ...
    public string GetItemNameNL(int id) {
        return TextManager.Get("ITEM_NAME_NL_" + id.ToString("000"));
    }
    ...
    public static bool IsConsumables(int id)
    {
        bool answer = true;
        for (int i = 0; i < notConsumableId.Length; i++)
        {
            if ((int)notConsumableId[i] == id)
            {
                answer = false;
                break;
            }
