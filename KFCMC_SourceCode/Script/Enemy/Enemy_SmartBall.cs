...
public class Enemy_SmartBall : EnemyBase {
    ...
    const int EffectJumpEnd = 4;
    const int ThrowVolcano = 0;
    const int AttackIndexJump = 1;
    ...
    void EmitEffectJumpEnd()
    {
        EmitEffect(EffectJumpEnd);
        if (level >= 5)
        {
    ...
    protected override void Update_StatusJudge() {
        ...
        {
            bool volcanoEnabled = state == State.Attack && level >= 5 && attackType == AttackIndexJump;
    ...
    protected override void Attack() {
        ...
        switch (attackTemp) {
            case 0:
                ...
                break;
            case 1:
                AttackBase(AttackIndexJump, 1.1f, 1.7f, 0, 150f / 60f + stiffPlus, 150f / 60f + stiffPlus + GetAttackInterval(1.5f, -1));
                agent.radius = 0.05f;
                break;
            case 2:
