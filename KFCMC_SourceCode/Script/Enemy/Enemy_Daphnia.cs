...
public class Enemy_Daphnia : EnemyBase
{
    ...
    void MoveAttack1()
    {
        ApproachOrSeparateBetween(2.3f, 1f);
    }
    ...
    protected override void SetLevelModifier()
    {
        ...
        attackWaitingLockonRotSpeed = (level >= 5 ? 20f : 4f);
    }
    ...
    protected override void Attack()
    {
        ...
        else
        {
            ...
            switch (attackTemp)
            {
                case 0:
                    fbStepTime = 15f / 60f;
                    AttackBase(level >= 5 ? 6 : 0, 1, 1.1f, 0, 75f / 60f, 75f / 60f + GetAttackInterval(1.5f));
                    break;
                case 1:
                    fbStepTime = 15f / 60f;
