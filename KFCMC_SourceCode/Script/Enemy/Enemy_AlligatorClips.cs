...
public class Enemy_AlligatorClips : EnemyBaseBoss {
    ...
    protected override void DamageCommonProcess() {
        ...
        if (!fixKnockAmount && lastDamagedColorType == damageColor_Critical && attackerCB == CharacterManager.Instance.pCon && enemyBalloonLoaded && enemyBalloonElements.PaperPlane.activeSelf) {
