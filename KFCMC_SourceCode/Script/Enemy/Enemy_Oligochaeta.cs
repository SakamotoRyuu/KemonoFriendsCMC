...
public class Enemy_Oligochaeta : EnemyBase
{
    ...
    {
        if (setTrapEnabled && trapPrefab && trapPivots[index])
        {
            ray.origin = trapPivots[index].position;
    ...
    void ThrowStartEarthShatter()
    {
        for (int i = 0; i < earthShatterCount; i++)
        {
