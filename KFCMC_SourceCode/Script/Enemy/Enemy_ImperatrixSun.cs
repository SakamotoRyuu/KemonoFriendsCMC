...
public class Enemy_ImperatrixSun : EnemyBase {
    ...
    public override void Attraction(GameObject decoy, AttractionType type, bool lockForce = false, float targetFixingTime = 0, bool isAttracterPlayer = false) { }

    public override void MakeAngry(GameObject decoyObject, CharacterBase attacker = null, bool isAttracterPlayer = false) { }

    public override void Confuse(bool isAttracterPlayer = false) { }
    ...
    {
        return requireKnock - (knockEndurance - knockRemain);
    }
