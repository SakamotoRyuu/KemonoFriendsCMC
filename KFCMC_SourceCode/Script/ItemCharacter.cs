...
public class ItemCharacter : MonoBehaviour {
    ...
    public bool notShowRescueMessage;
    ...
    protected LineCheckerBase lineChecker;
    ...
    protected virtual void Awake() {
        trans = transform;
        lineChecker = GetComponent<LineCheckerBase>();
    ...
    protected virtual void DungeonAction() {
        if (!InertIFR && (!isFriends || !exist)) {
            ...
            if (stageNumber >= bondConditionStage && !notShowRescueMessage) {
