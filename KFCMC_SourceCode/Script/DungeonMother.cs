...
public class DungeonMother : MonoBehaviour {
    ...
    public class ReaperSettings {
        ...
        public int appearAmbientNumber = -1;
        public int firstAlartCount = 700;
        public int secondAlartCount = 850;
        public int appearCount = 1000;
        public float conditionDefeatMultiplier = 25;
        public string alartTextHeader = "CAUTION_REAPER_";
        public bool countTextEnabled;
        public bool collapseOnAppearEnabled;
    ...
    {
        public bool overrideHomeEnabled;
        public int homeFloorNumber;
        public string returnToHomeText;
    }

    public enum GoldType { Gold, None, MemoryFragment };

    public int bonusFloorNum = -1;
    public int wrSpeedLevel;
    public int enemyLevelMax = 4;
    public bool comboRankEnabled;
    ...
    public const int defaultEnemyLevelMax = 4;
    bool movedOnceFlag;

    public void MoveFloor(int nextFloor = 1, int saveSlot = -1, bool additive = false, bool healDisabled = false) {
        if (StageManager.Instance != null) {
            ...
            CharacterManager.Instance.ResetForMoveFloor(healDisabled);
            ...
            if (floorNum < dungeonPrefab.Length && dungeonPrefab[floorNum] != null) {
                ...
                StageManager.Instance.GenerateDungeon(dungeonPrefab[floorNum], floorNum, healDisabled);
