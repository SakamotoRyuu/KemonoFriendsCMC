...
public class EffectDatabase : SingletonMonoBehaviour<EffectDatabase> {
    ...
    public enum id {
        ...
        sickFire, sickPoison, sickIce, sickAcid, sickSlow, sickStop, sickFrightened, sickFireEnemy, sickRadiation,
        ...
        itemCrystal_GS, itemCrystal_GM, itemCrystal_GL, itemCrystal_K, itemCrystal_R, itemCrystal_B, itemCrystal_V, itemCrystal_Y, itemCrystal_Y_DirectUse, itemCrystal_C, itemCrystal_W, 
        ...
        itemJaparibun01, itemJaparibun02, itemJaparibun03, itemJaparibun04, itemJaparibun05,
    ...
    protected override void Awake() {
        if (CheckInstance()) {
            ...
            prefab[(int)id.sickRadiation] = Resources.Load("Prefab/Effect/Eff_SickRadiation") as GameObject;
            ...
            prefab[(int)id.itemCrystal_Y_DirectUse] = Resources.Load("Prefab/Effect/Eff_ItemCrystal_Y_DirectUse") as GameObject;
            ...
            prefab[(int)id.itemJaparibun04] = Resources.Load("Prefab/Effect/Eff_ItemJaparibun04") as GameObject;
            prefab[(int)id.itemJaparibun05] = Resources.Load("Prefab/Effect/Eff_ItemJaparibun05") as GameObject;
            ...
            prefab[(int)id.friendsHyper] = Resources.Load("Prefab/Effect/Eff_FriendsHyper") as GameObject;
            prefab[(int)id.getMemoryOrb] = Resources.Load("Prefab/Effect/Eff_GetMemoryOrb") as GameObject;
            prefab[(int)id.comboHeal] = Resources.Load("Prefab/Effect/Eff_ComboHeal") as GameObject;
            prefab[(int)id.trueWildRelease] = Resources.Load("Prefab/Effect/Eff_TrueWildRelease") as GameObject;
        }
    }
