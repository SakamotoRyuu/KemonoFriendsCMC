...
public class GameManager : SingletonMonoBehaviour<GameManager> {
    ...
    public const int version = 1360200;
    ...
    public const int selectableFriendsMax = 32;
    public const int friendsMax = 34;
    ...
    public const int enemyLevelMax = 6;
    public const int enemySinWRLevel = 4;
    public const int enemyMax = 73;
    public const int enemyNormalLevelMax = 5;
    public const int enemyNormalMax = 67;
    public const int luckyBeastMax = 12;
    public const int zakoRushMax = 7;
    public const int zakoRushArrayMax = 56;
    public const int armsLockMax = 4;
    public const int armsLockIndex_Weapon = 0;
    public const int armsLockIndex_Skill = 1;
    public const int armsLockIndex_Amulet = 2;
    public const int armsLockIndex_Inventory = 3;
    ...
    public const int playerSelectReleaseVersion = 1330000;
    public const int memoryFragmentMax = 100;
    ...
    private static readonly int[] denotativeMaxFloor = new int[] { 2, 6, 9, 9, 9, 10, 9, 9, 9, 9, 9, 9, 15, 34, 33, -1, 51 };
    ...
    new int[] { 23, 23, 23, 23, 23, 23, 23, 23 }
    };
    ...
    public enum SecretType { SingularityLB, UndergroundLB, Toudai, SafePack, SkytreeCleared, CaveOfTribulationsCleared };
    ...
    public const int playerIndex_Serval = 0;
    public const int playerIndex_Parkman = 1;
    public const int playerIndex_HyperServal = 2;
    public const int playerIndex_AnotherServal = 3;
    public const int playerIndex_AnotherServal_Escape = 4;
    public const int clearFlag_Normal = 1;
    public const int clearFlag_Another = 2;
    public const int rescueMax = (selectableFriendsMax - 1) + hpUpNFSMax + stUpNFSMax + inventoryNFSMax + luckyBeastMax + 1;
    ...
    public const int equipmentID_InventoryUp = 23;

    public const int servalExLevelMax = 5;
    readonly string[] servalExLevelTexts = new string[servalExLevelMax]
    {
        "★", "★★", "★★★", "★★★★", "★★★★★"
    };

    public enum SteamAchievementName
    {
        GAMECLEAR,
        LONESOMESERVAL,
        ALLTROPHIES,
        ...
        BOSSRUSH2,
        ANOTHERQUEENRAW,
        CLEARCAVEOFTRIBULATIONS
    }
    const int steamAchievementMax = 8;
    bool[] steamAchievementFlags = new bool[steamAchievementMax];
    ...
    public class Save {
        [SerializeField]
        public int dataExist, difficulty, progress, nowStage, nowFloor, exp, expStorage, money, hpUpSale, stUpSale, playerHP, minmi, tutorial, secret, randomSeed, isExpPreserved, unlockCount, playerType, playerIndex, isPlayerHyper, moveByBus, facilityDisabled, servalExLevel, memoryFragment, memoryBonus;
        [SerializeField]
        ...
        public int GotFriends {
            get {
                int answer = 0;
                for (int i = 1; i < selectableFriendsMax && i < friends.Length; i++) {
                    if (friends[i] != 0) {
                        answer++;
                    }
                }
        ...
        public int GotInvUp {
            get {
                ...
                if (isExpPreserved != 0)
                {
                    int lockedTemp = Mathf.Clamp(inventoryNFSMax - armsLocked[armsLockIndex_Inventory] * 2, 0, inventoryNFSMax);
                    if (answer > lockedTemp)
                    {
                        answer = lockedTemp;
                    }
                }
        ...
        public int GotHpUp {
            get {
                ...
                if (isExpPreserved != 0 && answer > unlockCount) {
                    answer = unlockCount;
                }
            ...
            if (Instance) {
                switch (index) {
                    ...
                    case 23:
                        return false;
                    case 3:
                        return armsLocked[armsLockIndex_Weapon] >= 9 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 1);
                    case 6:
                        return armsLocked[armsLockIndex_Weapon] >= 8 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 1);
                    case 11:
                        return armsLocked[armsLockIndex_Weapon] >= 7 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 5);
                    case 4:
                        return armsLocked[armsLockIndex_Weapon] >= 6 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 5);
                    case 7:
                        return armsLocked[armsLockIndex_Weapon] >= 5 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 5);
                    case 9:
                        return armsLocked[armsLockIndex_Weapon] >= 4 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 5);
                    case 5:
                        return armsLocked[armsLockIndex_Weapon] >= 3 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 10);
                    case 8:
                        return armsLocked[armsLockIndex_Weapon] >= 2 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 10);
                    case 10:
                        return armsLocked[armsLockIndex_Weapon] >= 1 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 10);
                    case 12:
                        return armsLocked[armsLockIndex_Skill] >= 8 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 1);
                    case 13:
                        return armsLocked[armsLockIndex_Skill] >= 7 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 1);
                    case 14:
                        return armsLocked[armsLockIndex_Skill] >= 6 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 1);
                    case 15:
                        return armsLocked[armsLockIndex_Skill] >= 5 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 5);
                    case 16:
                        return armsLocked[armsLockIndex_Skill] >= 4 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 5);
                    case 17:
                        return armsLocked[armsLockIndex_Skill] >= 3 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 5);
                    case 18:
                        return armsLocked[armsLockIndex_Skill] >= 2 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 10);
                    case 19:
                        return armsLocked[armsLockIndex_Skill] >= 1 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 12);
                    case 20:
                        return (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 12);
                    case 24:
                        return armsLocked[armsLockIndex_Amulet] >= 8 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 2);
                    case 25:
                        return armsLocked[armsLockIndex_Amulet] >= 7 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 3);
                    case 26:
                        return armsLocked[armsLockIndex_Amulet] >= 6 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 4);
                    case 27:
                        return armsLocked[armsLockIndex_Amulet] >= 5 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 6);
                    case 28:
                        return armsLocked[armsLockIndex_Amulet] >= 4 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 7);
                    case 29:
                        return armsLocked[armsLockIndex_Amulet] >= 3 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 8);
                    case 30:
                        return armsLocked[armsLockIndex_Amulet] >= 2 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 9);
                    case 31:
                        return armsLocked[armsLockIndex_Amulet] >= 1 || (Instance.equipmentLimitEnabled && Instance.armsStage > 0 && Instance.armsStage <= 11);
                    default:
                        return false;
                }
            }
        ...
        public bool AddItem(int id) {
            if (id < 100) {
                ...
                itemExperience[id / bitUnit] |= (1 << (id % bitUnit));
        ...
        public void ResetQualityConfig(int quality) {
            ...
            config[configID_ClothSimulation] = (quality >= 2 ? 2 : quality == 1 ? 1 : 0);
        ...
        public void PreserveExp(bool isHard) {
            if (isExpPreserved == 0) {
                expStorage = exp;
                exp = 0;
                ...
                armsLocked[armsLockIndex_Weapon] = 9;
                armsLocked[armsLockIndex_Skill] = 8;
                armsLocked[armsLockIndex_Amulet] = 8;
                if (isHard)
                {
                    armsLocked[armsLockIndex_Inventory] = 8;
                    unlockCount = 0;
                }
                else
                {
                    armsLocked[armsLockIndex_Inventory] = 0;
                    unlockCount = 10;
                }
    ...
    public void InitSave(int playerType = 0) {
        ...
        save.playerIndex = GetOriginallyPlayerIndex;
    ...
    public int GetOriginallyPlayerIndex
    {
        get
        {
            switch (save.playerType)
            {
                case playerType_Normal:
                    return playerIndex_Serval;
                case playerType_Another:
                    return playerIndex_AnotherServal;
                default:
                    return playerIndex_Serval;
            }
        }
    ...
    void FixVersion() {
        if (save.version < version) {
            ...
            if (save.version < 1110003) {
                ...
                if (save.version == 11100 && AnyTrophyExist()) {
                    ...
                    for (int index = 0; index < 58; index++) {
                        int arrayNum = index / bitUnit;
                        int bitNum = 1 << (index % bitUnit);
                        if ((save.trophy[arrayNum] & bitNum) != 0) {
                            ...
                            if (newIndex >= 0) {
                                int newArrayNum = newIndex / bitUnit;
                                int newBitNum = 1 << (newIndex % bitUnit);
                ...
                if (itemsCount > 0) {
                    for (int i = 0; i < itemsCount; i++) {
                        ...
                        if (idTemp >= 0 && idTemp < 100) {
                            save.itemExperience[idTemp / bitUnit] |= (1 << (idTemp % bitUnit));
                        }
                    }
                }
            ...
            if (save.version < 1330000)
            {
                switch (save.playerType)
                {
                    case 0: // Normal
                        save.playerType = playerType_Normal;
                        save.playerIndex = playerIndex_Serval;
                        save.isPlayerHyper = 0;
                        break;
                    case 1: // Another
                        save.playerType = playerType_Another;
                        save.playerIndex = playerIndex_AnotherServal;
                        save.isPlayerHyper = 0;
                        break;
                    case 2: // Hyper
                        save.playerType = playerType_Normal;
                        save.playerIndex = playerIndex_HyperServal;
                        save.isPlayerHyper = 1;
                        break;
                    case 3: // AnotherEscape
                        save.playerType = playerType_Another;
                        save.playerIndex = playerIndex_AnotherServal_Escape;
                        save.isPlayerHyper = 0;
                        break;
                    default:
                        save.playerType = playerType_Normal;
            ...
            if (save.version < 1330100)
            {
                if (save.friends.Length < 34)
                {
                    int[] newFriends = new int[34];
                    for (int i = 0; i < newFriends.Length && i < save.friends.Length; i++)
                    {
                        newFriends[i] = save.friends[i];
                    }
                    save.friends = newFriends;
                }
                if (save.friendsLiving.Length < 34)
                {
                    int[] newFriendsLiving = new int[34];
                    for (int i = 0; i < newFriendsLiving.Length && i < save.friendsLiving.Length; i++)
                    {
                        newFriendsLiving[i] = save.friendsLiving[i];
                    }
                    save.friendsLiving = newFriendsLiving;
                }
                save.servalExLevel = 0;
                // Shift Japariman ID 72 -> 74, 71 -> 72
                const int oldJm5 = 72;
                const int newJm5 = 74;
                const int oldJm3 = 71;
                const int newJm3 = 72;
                ...
                {
                    if (save.items[i] == oldJm5)
                    {
                        save.items[i] = newJm5;
                    } 
                    else if (save.items[i] == oldJm3)
                    {
                        save.items[i] = newJm3;
                    }
                }
                ...
                {
                    if (save.storage[i] == oldJm5)
                    {
                        save.storage[i] = newJm5;
                    }
                    else if (save.storage[i] == oldJm3)
                    {
                        save.storage[i] = newJm3;
                    }
                }

                for (int i = 0; i < save.itemsPreserve.Count; i++)
                {
                    if (save.itemsPreserve[i] == oldJm5)
                    {
                        save.itemsPreserve[i] = newJm5;
                    }
                    else if (save.itemsPreserve[i] == oldJm3)
                    {
                        save.itemsPreserve[i] = newJm3;
                    }
                }
                
                if (save.itemExperience.Length >= itemExperienceArrayMax)
                {
                    if ((save.itemExperience[oldJm5 / bitUnit] & (1 << (oldJm5 % bitUnit))) != 0)
                    {
                        save.itemExperience[oldJm5 / bitUnit] ^= (1 << (oldJm5 % bitUnit));
                        save.itemExperience[newJm5 / bitUnit] |= (1 << (newJm5 % bitUnit));
                    }
                    if ((save.itemExperience[oldJm3 / bitUnit] & (1 << (oldJm3 % bitUnit))) != 0)
                    {
                        save.itemExperience[oldJm3 / bitUnit] ^= (1 << (oldJm3 % bitUnit));
                        save.itemExperience[newJm3 / bitUnit] |= (1 << (newJm3 % bitUnit));
                    }
                }
            }

            if (save.version < 1330200)
            {
                // enemyLevelMax 5 -> 6
                if (save.defeatEnemy.Length < 67 * 6)
                {
                    int[] defeatEnemy = new int[67 * 6];
                    for (int i = 0; i < 67; i++)
                    {
                        for (int j = 0; j < 5; j++)
                        {
                            if (i * 5 + j < save.defeatEnemy.Length)
                            {
                                defeatEnemy[i * 6 + j] = save.defeatEnemy[i * 5 + j];
                            }
                            else
                            {
                                break;
                    ...
                    save.defeatEnemy = defeatEnemy;
                }
            }
            if (save.version < 1360000)
            {
                save.memoryFragment = 0;
                int[] armsLocked = new int[4];
                for (int i = 0; i < save.armsLocked.Length && i < armsLocked.Length; i++)
                {
                    armsLocked[i] = save.armsLocked[i];
                }
                save.armsLocked = armsLocked;
                if (save.nowStage == 14)
                {
                    save.unlockCount += 10;
                }
                if (save.defeatEnemy.Length < 73 * 6)
                {
                    int[] defeatEnemy = new int[73 * 6];
                    for (int i = 0; i < 73 * 6; i++)
                    {
                        if (i < save.defeatEnemy.Length)
                        {
                            defeatEnemy[i] = save.defeatEnemy[i];
                        }
                        else
                        {
                            break;
    ...
    void ShiftTrophy(int startIndex, int shiftNum) {
        ...
        for (int index = 0; index + shiftNum < trophyArrayMax * bitUnit; index++) {
            int arrayNum = index / bitUnit;
            int bitNum = 1 << (index % bitUnit);
            if ((save.trophy[arrayNum] & bitNum) != 0) {
                int newArrayNum = index >= startIndex ? (index + shiftNum) / bitUnit : arrayNum;
                int newBitNum = index >= startIndex ? 1 << ((index + shiftNum) % bitUnit) : bitNum;
                trophyTemp[newArrayNum] |= newBitNum;
            }
        }
        save.trophy = trophyTemp;
    ...
    public int GetJaparimanCount() {
        return Instance.save.NumOfSpecificItems((int)ItemDatabase.ItemID.Japariman)
            + Instance.save.NumOfSpecificItems((int)ItemDatabase.ItemID.Japariman_2) * 2
            + Instance.save.NumOfSpecificItems((int)ItemDatabase.ItemID.Japariman_3) * 3
            + Instance.save.NumOfSpecificItems((int)ItemDatabase.ItemID.Japariman_4) * 4
            + Instance.save.NumOfSpecificItems((int)ItemDatabase.ItemID.Japariman_5) * 5;
    }
    ...
    public void FixProgressWeapon()
    {
        if (!IsPlayerAnother)
        {
            int[,] progressWeapon = new int[11, 2] {
                { 0, 0 },
                { 0, 1 },
                { 0, 2 },
                { 2, 24 }, // Amulet
                ...
                { 8, 29 }, // Seiryu
                { 9, 30 }, // Inugami-gyobu
                { 11, 31 } // Perfect Amulet
            };
            for (int i = 0; i < 11; i++)
            {
                if ((save.progress >= progressWeapon[i, 0] || progressWeapon[i, 0] <= 0) && save.weapon[progressWeapon[i, 1]] == 0)
                {
                ...
                else if (save.progress < progressWeapon[i, 0] && save.weapon[progressWeapon[i, 1]] != 0)
                {
                    ...
                    save.weapon[progressWeapon[i, 1]] = 0;
                    save.equip[progressWeapon[i, 1]] = 0;
                }
            }
        }
    }
    ...
    public void DataOverwriteLanguage(int language) {
        for (int saveSlot = 0; saveSlot < saveSlotMax; saveSlot++) {
            Save saveTemp = SaveData.GetClass<Save>(str_Save + saveSlot.ToString(), null);
            if (saveTemp != null && saveTemp.dataExist != 0) {
                saveTemp.language = language;
                SaveData.SetClass<Save>(str_Save + saveSlot.ToString(), saveTemp);
            }
        }
        SaveData.Save();
    }

    public void DataOverwriteVolume(int seVolume, int musicVolume, int ambientVolume) {
        for (int saveSlot = 0; saveSlot < saveSlotMax; saveSlot++) {
            Save saveTemp = SaveData.GetClass<Save>(str_Save + saveSlot.ToString(), null);
            if (saveTemp != null && saveTemp.dataExist != 0) {
                saveTemp.seVolume = seVolume;
                saveTemp.musicVolume = musicVolume;
                saveTemp.ambientVolume = ambientVolume;
                SaveData.SetClass<Save>(str_Save + saveSlot.ToString(), saveTemp);
            }
        }
        SaveData.Save();
    ...
    public void FixSaveDefeatEnemyArray()
    {
        if (save.defeatEnemy.Length < enemyMax * enemyLevelMax)
        {
            int[] defeatEnemy = new int[enemyMax * enemyLevelMax];
            // レベル数は合っているが敵種類数が小さい
            if (save.defeatEnemy.Length % enemyLevelMax == 0)
            {
                for (int i = 0; i < enemyMax * enemyLevelMax; i++)
                {
                    if (i < save.defeatEnemy.Length)
                    {
                        defeatEnemy[i] = save.defeatEnemy[i];
            ...
            else
            {
                ...
                for (int i = 0; i < enemyMax; i++)
                {
                    for (int j = 0; j < 5; j++)
                    {
                        if (i * 5 + j < save.defeatEnemy.Length)
                        {
                            defeatEnemy[i * enemyLevelMax + j] = save.defeatEnemy[i * 5 + j];
                        }
                        else
                        {
                            break;
    ...
    public void MixSnapshot(string[] snapshotNames, float[] amounts, float transitionTime = 0f)
    {
        nowSnapshotName = "";
        AudioMixerSnapshot[] snapshots = new AudioMixerSnapshot[snapshotNames.Length];
        for (int i = 0; i < snapshotNames.Length; i++)
        {
            snapshots[i] = audioMixer.FindSnapshot(snapshotNames[i]);
        }
        audioMixer.TransitionToSnapshots(snapshots, amounts, transitionTime);
    }
    ...
    public static int GetJaparibunType(int id) {
        int answer = 0;
        switch (id)
        {
            ...
            if (save.progress < 3 && save.difficulty >= 2 && gameOverCount >= 3) {
                ...
                switch (save.tutorial) {
                    ...
                    case 28:
                        ...
                        break;
                    case 29:
                        if (stageNumber == 16 && floorNumber == 0)
                        {
                            save.tutorial = answer = 30;
                            tutorialContinuousFlag = true;
                        }
                        break;
                    case 30:
    ...
    public bool IsPlayerAnother => (save.playerType == playerType_Another);
    ...
    public void SetSteamAchievement(SteamAchievementName apiName) {
        if (steamAchievementFlags[(int)apiName] == false && steamManager != null && SteamManager.Initialized && save.config[Save.configID_DisableTrophy] == 0) {
            SteamManager.SetAchievement(apiName.ToString());
            steamAchievementFlags[(int)apiName] = true;
        }
    }

    public bool IsStandardPlayer(Save saveTemp)
    {
        return saveTemp.version < playerSelectReleaseVersion
                || (saveTemp.playerType == playerType_Normal && (saveTemp.playerIndex == playerIndex_Serval || saveTemp.playerIndex == playerIndex_HyperServal))
                || (saveTemp.playerType == playerType_Another && (saveTemp.playerIndex == playerIndex_AnotherServal || saveTemp.playerIndex == playerIndex_AnotherServal_Escape));
    }

    public bool IsStandardPlayer()
    {
        return IsStandardPlayer(save);
    }

    public string GetServalExLevelText()
    {
        if (save != null && save.servalExLevel >= 1)
        {
            return servalExLevelTexts[Mathf.Clamp(save.servalExLevel - 1, 0, servalExLevelTexts.Length - 1)];
        }
        return "";
    }

    public bool CanBringInventory()
    {
        return save.HaveSpecificItem((int)ItemDatabase.ItemID.CertificateOfEnlightenment);
    }
