...
public class EndingTrigger_Another : MonoBehaviour {
        ...
        switch (progress) {
            ...
            case 2:
                if (elapsedTime >= 3f) {
                    ...
                    CharacterManager.Instance.pCon.DestroySupermanDuringEffectObj();
            ...
            case 4:
                if (elapsedTime >= 6.5f) {
                    ...
                    CharacterManager.Instance.pCon.Event_SetHyperJumpEffectVolume(0f);
    ...
    private void OnTriggerEnter(Collider other) {
        if (progress == 0 && other.CompareTag("ItemGetter")) {
            ...
            if (CharacterManager.Instance.playerIndex != GameManager.playerIndex_AnotherServal_Escape) {
                CharacterManager.Instance.SetNewPlayer(GameManager.playerIndex_AnotherServal_Escape, false);
            }
