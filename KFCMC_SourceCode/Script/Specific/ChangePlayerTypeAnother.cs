                ...
                case 1:
                    if (PauseController.Instance) {
                        ...
                        if (pauseWait <= 0 && coolTime <= 0f && PauseController.Instance.GetPauseEnabled() && playerInput.GetButtonDown(RewiredConsts.Action.Submit)) {
                            ...
                            PauseController.Instance.SetChoices(2, true, TextManager.Get("CHOICE_SWITCH_STORY"), isAnother ? "CHOICE_CELLIEN_MAY_CRY" : "CHOICE_LONESOME_SERVAL", "CHOICE_CANCEL");
                            state = 2;
                        }
                    }
                    break;
                case 2:
                    switch (PauseController.Instance.ChoicesControl()) {
                        ...
                        case 0:
                            ...
                            CharacterManager.Instance.SetNewPlayer(GameManager.Instance.GetOriginallyPlayerIndex);
                            ...
                            MessageUI.Instance.SetMessageReplace(TextManager.Get("MESSAGE_OVERWRITE_SAVE"), "MESSAGE_OVERWRITE_SAVE", 10, MessageUI.panelType_Information, MessageUI.slotType_Caution);
                            CancelCommon();
                            break;
                        case 1:
                            UISE.Instance.Play(UISE.SoundName.submit);
